pub const PIRATE_ADVENTURE: &str = r#" 5724 
66 
177 
79 
26 
...
"Its a map to Treasure Island. At the bottom it says:
  `30 paces then dig!`"
"* Welcome to Adventure number 2: `PIRATE ADVENTURE` by Alexis and Scott Adams.
Dedicated to Ted Heeren and Paul Sharland.
